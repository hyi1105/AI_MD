...
> 更新：2026-08-14（追加：個人理財／控支出＋投資起手）
...
#### 2026-08-14 — 個人理財：先控支出、再投資起手
- 狀態：waiting-owner  
- 來源：對話（原文關鍵句：「我想你幫我理財 我最近花太了 也想要投資 能怎麼做」）  
- 為什麼（Why）：花太多卻想投資時，若沒先看清現金流，投資會變成「一邊漏水一邊倒水」；不做會繼續焦慮、存不下、也談不上複利。  
- 做什麼（What）：使用者能完成三件事：（1）看清每月錢從哪來／花去哪；（2）用簡單規則把支出壓下來並先存一筆緊急備用金；（3）用低門檻、可長期持有的方式開始投資（待拍板：產品是「本站工具／知識書」還是「對話陪跑清單」）。  
- 怎麼做（How）：  
  - 若做**對話陪跑**（最小）：只維持 idea＋每週回報模板，不動 code。  
  - 若做**本站工具**：本機記帳／分類支出（localStorage）＋月結一頁＋「先存再花／緊急金進度」；投資區只放教育與配置檢查清單（不做券商下單）。  
  - 若做**知識書**：一篇「控支出→緊急金→定期定額」長文＋可回訪更新。  
  - 細節確認前：**只改 MD、不動 code、不上線**。  
- 優點（Pros）：順序正確（現金流→備用金→投資）；可當生活工具或主題知識書；門檻低。  
- 缺點／風險（Cons）：涉及金錢建議需標「非投資顧問／非保證報酬」；若做記帳工具要防隱私外洩；投資內容易過時、法遵敏感。  
- 不做的替代方案：不建產品，只用對話給「本月控支＋投資起手」清單，負責人自己用試算表。  
- 完成後列入 checklist：能完成「記一筆支出／看月結／看緊急金進度／讀投資起手清單」（若做成產品）；若僅陪跑則不進 checklist。  
- 待拍板：  
  1. 這次要的是**個人陪跑**、還是**做成網站工具／知識書**？  
  2. 幣別與地區（台幣／台灣為主？）  
  3. 每月大概收入區間、固定支出、目前存款／負債（可粗估，不必精準）  
  4. 「花太多」主要在哪類（外食、訂閱、衝動購物、交際…）？  
  5. 投資風險偏好：保守／中庸／積極？能接受多久不賣？  
  6. 有無緊急備用金（建議先存 3～6 個月生活費）？  
