...
- [x] **方案地圖說明**：給解法／程式時先骨架、用為什麼引導、**同則展到檔案層**；結尾 **3 則選擇題**（體檢／先觀察；規則見 `prompts/AGENT-MASTER.md` §7；`.mdc` 已掛）  
- [x] 目錄只靠 JSON  
...
- [x] 2026-08-13 方案地圖說明規則已寫入 AGENT-MASTER／`.mdc`  
- [x] 2026-08-13 方案地圖微調：同則展到檔案層；程式最後；選擇題先觀察
