...
- 結果：done（已發布）  
- 來源：對話＋參考圖（「幫我把簽核系統用這個方式畫出來」）  
- 摘要：`web/approval/flow.html`＋`flow.css`；紅標題／深藍起點／橘成功／灰失敗分叉；對齊 draft→submit→核准／駁回／退回；首頁與簽核 Demo 入口。線上 https://hyi1105.github.io/AI_MD/approval/flow.html  
